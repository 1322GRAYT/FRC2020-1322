...
public class DRV_RotToAngRel extends CommandBase {
  /**
  ...
  private final double Xe_Deg_RotAngDsrd;
  ...
  public DRV_RotToAngRel(DriveSubsystem driveSubsystem, double Le_Deg_RotAngDsrd) {
    this.driveSubsystem = driveSubsystem;
    Xe_Deg_HdgAngInit = driveSubsystem.getGyroAngRaw();
    Xe_Deg_RotAngDsrd = Le_Deg_RotAngDsrd;
